...
if($batch == '1stBatch' || $batch == '2ndBatch' || $batch == '4thBatch' )
{$sql1="update LMS.record set Date_of_Issue=curdate(),Due_Date=date_add(curdate(),interval 15 day),Renewals_left=1 where BookId='$bookid' and RollNo='$rollno'";
...
{$sql2="update LMS.record set Date_of_Issue=curdate(),Due_Date=date_add(curdate(),interval 15 day),Renewals_left=1 where BookId='$bookid' and RollNo='$rollno'";
